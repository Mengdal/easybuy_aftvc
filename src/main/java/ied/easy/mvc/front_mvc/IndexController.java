...
public class IndexController {
    ...
    public String productView(@Param("id") Integer id, Model model, HttpServletRequest request, HttpServletResponse response,HttpSession session){
        //获取Cookie
        Cookie[] cookies=request.getCookies();
    ...
    public String Product_shopping(Model model,HttpSession session){
        // 列表显示所有商品信息
